...
export default async function DashboardPage() {
  ...
  return (
    <>
      <Topbar title="Dashboard" role={session.role} subtitle={subtitle} viewMode={viewMode} />
